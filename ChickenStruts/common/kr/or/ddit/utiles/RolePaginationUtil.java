...
public class RolePaginationUtil {
	...
	public RolePaginationUtil(HttpServletRequest request, int currentPage,
			int totalCount, String search_keyword, String search_keycode) {
	...
	private void makePagination() {
		...
		if ((this.currentPage - 1) == 0) {
			...
			this.pagingHtmls.append("<li><a href='" + requestURI
					+ "?currentPage=" + (this.currentPage - 1)+ "&search_keyword="+this.search_keyword+"&search_keycode="+this.search_keycode 
					+ "'>&laquo;</a></li>");
		}
		// |1|2|3|4|5|
		for (int i = this.startPage; i <= this.endPage; i++) {
			if (this.currentPage == i) {
				...
				this.pagingHtmls.append("<li><a href='" + requestURI
						+ "?currentPage=" + i  + "&search_keyword="+this.search_keyword+"&search_keycode="+this.search_keycode + "'>" + i + "</a></li>");
			}
		}
