...
<%-- <c:set var="DeleteURI" value="/user/member/deleteMemberInfo.do"></c:set> --%>
		...
		<tr valign="top">
			...
			<td width="790">
				<div id="container">
					...
					<form method="post" name="updateMemberForm" action="${pageContext.request.contextPath }/user/member/updateMemberInfo.do">
						...
						<div style="float: right;">
							...
							<input class="btn3" type="button" value="탈퇴신청" />
						</div>
					</form>
				</div>
			</td>
