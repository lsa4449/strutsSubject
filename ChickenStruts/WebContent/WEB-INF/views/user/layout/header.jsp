		            ...
		            <ul class="nav navbar navbar-top-links navbar-right mbn">
		               ...
		               <li class="dropdown">
		                  <a data-hover="dropdown" href="#" class="dropdown-toggle">
		                     ...
		                     <span class="hidden-xs">${LOGINMEMBERINFO.mem_name }</span>&nbsp;<span class="caret"></span>
		                  </a>
		                  <ul class="dropdown-menu" role="menu">
		                     <li id="li"><a href="${pageContext.request.contextPath }/user/member/memberUpdate1.do"><i class="fa fa-user"></i>정보관리</a></li>
